...
export const contentFields: Record<ContentType, readonly FieldDef[]> = {
  verein: [
    ...
    { name: "kurzbeschreibung", label: "Kurzbeschreibung", kind: "textarea", required: true },
    ...
    { name: "ansprechpartner", label: "Ansprechpartner", kind: "text", required: false },
  ...
  engagement: [
    { name: "titel", label: "Titel", kind: "text", required: true },
    { name: "beschreibung", label: "Beschreibung", kind: "textarea", required: true },
    { name: "art", label: "Art", kind: "select", required: true, options: engagementArtValues },
    { name: "kontakt", label: "Kontakt", kind: "text", required: true },
    { name: "vereinId", label: "Verein-ID", kind: "text", required: true },
    { name: "vereinName", label: "Vereinsname", kind: "text", required: true },
  ],
  barrierefreiheit: [
    { name: "name", label: "Name", kind: "text", required: true },
    { name: "kategorie", label: "Kategorie", kind: "select", required: true, options: barriereKategorieValues },
    { name: "strasse", label: "Straße", kind: "text", required: true },
    { name: "facharzt", label: "Fachrichtung", kind: "text", required: false },
    { name: "telefon", label: "Telefon", kind: "tel", required: false },
    { name: "zugang", label: "Zugang", kind: "select", required: true, options: barriereStatusValues },
    { name: "sehbehinderung", label: "Sehbehinderung", kind: "select", required: true, options: barriereStatusValues },
    { name: "wc", label: "WC", kind: "select", required: true, options: barriereStatusValues },
    { name: "parkplatz", label: "Parkplatz", kind: "select", required: true, options: barriereStatusValues },
  ],
};
...
export const ingestRequiredFields: Record<ContentType, readonly string[]> = {
  barrierefreiheit: ["name", "kategorie", "strasse", "zugang", "sehbehinderung", "wc", "parkplatz"],
  engagement: ["titel", "beschreibung", "vereinId", "vereinName", "art", "kontakt"],
  veranstaltung: ["titel", "beschreibung", "datum", "uhrzeit", "ort", "vereinId", "vereinName", "kategorie", "kontakt"],
  verein: ["name", "kurzbeschreibung", "beschreibung", "kategorie", "zielgruppe", "angebote", "ansprechpartner", "email", "telefon", "adresse"],
};
