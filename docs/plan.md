...
- [ ] 0.1 **AWS-Deploy-Status live prüfen** (`BesigheimConnectBackend`). *Braucht AWS-Profil `unser-besigheim`.*
...
- [ ] 0.3 **Clerk einrichten** — Application, Organizations-Feature, Rollen (`member`, `admin`), Keys als Env-Vars. *Braucht Clerk-Account.*
